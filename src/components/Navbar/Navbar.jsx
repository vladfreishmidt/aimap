   ...
   return (
      <nav className={s.nav}>
         <div className={s.top}>
               ...
               <NavLink className={s.logo} activeClassName="active" to="/">
                  <img src="../../assets/images/logo.svg" alt="aimap logo"/>
               </NavLink>

               <NavLink className={s.link} activeClassName={s.active} to="/map">
               ...
               <NavLink className={s.link} activeClassName={s.active} to="/dashboard">
